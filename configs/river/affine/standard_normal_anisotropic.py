...
def get_config():
    ...
    config.checkpoint = '/store/CIA/gb511/projects/riemannian-geometry/code/results/river/affine/standard_normal_anisotropic/checkpoints/checkpoint_epoch_498_loss_2.395.pth' 
