...
def get_config():
    ...
    config.checkpoint = '/store/CIA/gb511/projects/riemannian-geometry/code/results/river/affine/standard_normal/checkpoints/checkpoint_epoch_329_loss_2.483.pth'
