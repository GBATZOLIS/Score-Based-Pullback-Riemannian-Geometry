...
def get_config():
    ...
    config.checkpoint = None #'/home/gb511/riemannian_geo/results/hemisphere/5_20/affine_jacobian_iso_vol_weights_0.75_1.2/checkpoints/checkpoint_epoch_1593_loss_-74.757.pth'
