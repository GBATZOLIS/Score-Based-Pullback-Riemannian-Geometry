...
def get_config():
    ...
    # Logging settings
    config.base_log_dir = "./results/hemisphere/3_5"
    config.experiment = "affine_jacobian_iso_vol_weights_0.5_0.1"
    ...
    config.use_reg = True
    config.reg_factor = 1
    config.lambda_iso = 0.5
    config.lambda_vol = 0.1
    ...
    config.checkpoint = '/home/gb511/riemannian_geo/results/hemisphere/3_5/affine_jacobian_iso_vol_weights_0.5_0.1/checkpoints/checkpoint_last.pth'
