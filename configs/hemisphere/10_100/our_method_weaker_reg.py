...
def get_config():
    ...
    # Logging settings
    config.base_log_dir = "./results/hemisphere/10_100"
    config.experiment = "affine_jacobian_iso_vol_weights_0.6_0.6"
    ...
    config.use_reg = True
    config.reg_factor = 1
    config.lambda_iso = 0.6
    config.lambda_vol = 0.6
    ...
    config.dataset = 'hemisphere_10_100'
    ...
    config.checkpoint = '/home/gb511/riemannian_geo/results/hemisphere/10_100/affine_jacobian_iso_vol_weights_0.6_0.6/checkpoints/checkpoint_last.pth'
