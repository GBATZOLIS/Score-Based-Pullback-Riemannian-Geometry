...
def get_config():
    ...
    config.experiment = "deep_affine_jacobian_iso_vol_weights_0.4_0.5"
    ...
    config.use_reg = True
    config.reg_factor = 1
    config.lambda_iso = 0.4
    config.lambda_vol = 0.5
