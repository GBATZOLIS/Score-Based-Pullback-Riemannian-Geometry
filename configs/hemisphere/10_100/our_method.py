...
def get_config():
    ...
    config.experiment = "affine_jacobian_iso_vol_weights_2_2"
    ...
    config.checkpoint = '/home/gb511/riemannian_geo/results/hemisphere/10_100/affine_jacobian_iso_vol_weights_2_2/checkpoints/checkpoint_epoch_123_loss_-258.335.pth'
