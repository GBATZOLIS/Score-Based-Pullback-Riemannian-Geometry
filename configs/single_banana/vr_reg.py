...
def get_config():
    ...
    config.std = 1e-1
    config.use_reg = True #use regularisation to enforce that phi is local isometry
    config.reg_factor = 1.0
    config.use_cv = True #use variance reduction (vr) with control variates
