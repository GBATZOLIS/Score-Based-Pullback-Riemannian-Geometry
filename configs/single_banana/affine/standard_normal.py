...
def get_config():
    ...
    config.checkpoint = '/store/CIA/gb511/projects/riemannian-geometry/code/results/single_banana/affine/standard_normal/checkpoints/checkpoint_epoch_136_loss_2.723.pth'
