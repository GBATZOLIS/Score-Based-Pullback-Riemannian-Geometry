...
def get_config():
    ...
    # Logging settings
    config.base_log_dir = "./results/blobs/100"
    ...
    config.num_gaussians = 100  # Number of Gaussians per image
    config.std_range = [1, 5]  # Standard deviation range for Gaussians
    config.data_samples = 300 #100000 # Number of samples in the dataset
    ...
    config.checkpoint = 'checkpoint_epoch_181_loss_-6498.473.pth'
