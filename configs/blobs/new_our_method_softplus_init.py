...
def get_config():
    ...
    config.experiment = "new_our_method_softplus_init"
    config.eval_log_frequency = 5
    ...
    config.std = 5e-3 #the chosen std is critical and it depends on the dataset. We should create a rigorous method that estimates the optimal std.
    config.use_reg = True
    ...
    config.dataset_class = 'modified_blob_manifold'  # Matches the class name
