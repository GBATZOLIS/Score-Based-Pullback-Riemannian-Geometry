...
def get_config():
    ...
    config.experiment = "our_method_rq_regfactor_1e-2"
    ...
    config.std = 1e-2 #the chosen std is critical and it depends on the dataset. We should create a rigorous method that estimates the optimal std.
    config.use_reg = True
    config.reg_factor = 0.01
