...
def get_config():
    ...
    config.experiment = "our_method_init"
    ...
    config.checkpoint = '/home/gb511/riemannian_geo/results/squeezed_single_banana/affine/our_method_init/checkpoints/checkpoint_epoch_555_loss_1.939.pth'
