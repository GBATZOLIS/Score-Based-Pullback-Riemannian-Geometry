...
def get_config():
    ...
    config.experiment = "fast_affine_iso_vol_hessian_lowerreg_resume"
    ...
    config.use_reg = True
    config.reg_factor = 1
    config.lambda_iso = 110 #125
    config.lambda_vol = 2 #10
    config.lambda_hessian = 1 #5
    config.num_v = 2
    ...
    config.checkpoint = '/home/gb511/riemannian_geo/results/mnist/fast_affine_iso_vol_hessian_lowerreg/checkpoints/checkpoint_epoch_806_loss_-4203.804.pth'
