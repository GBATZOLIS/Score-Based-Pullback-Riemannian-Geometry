...
def get_config():
    ...
    config.experiment = "affine_no_reg"
    ...
    config.use_reg = False #NOTE WE SET USE_REG TO FALSE. THIS MAKES SURE THAT WE TRAIN AN UNREGULARIZED ANISOTROPIC FLOW FOR BENCHMARKING PURPOSES.
    config.reg_factor = 1
    ...
    config.checkpoint = None #'/home/gb511/riemannian_geo/results/sinusoid/5_20/affine_24layers_jacobian_iso_vol_weights_1.2_2.5/checkpoints/checkpoint_epoch_1493_loss_-6.120.pth'
