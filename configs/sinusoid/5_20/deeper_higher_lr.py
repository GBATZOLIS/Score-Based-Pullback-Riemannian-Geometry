...
def get_config():
    ...
    config.experiment = "deeper_higher_lr_affine_jacobian_iso_vol_weights_1_2"
    ...
    config.checkpoint = '/home/gb511/riemannian_geo/results/sinusoid/5_20/deeper_higher_lr_affine_jacobian_iso_vol_weights_1_2/checkpoints/checkpoint_epoch_889_loss_-2.558.pth'
