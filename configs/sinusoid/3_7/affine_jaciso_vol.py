...
def get_config():
    ...
    # Logging settings
    config.base_log_dir = "./results/sinusoid/3_7"
    ...
    config.checkpoint = '/home/gb511/riemannian_geo/results/sinusoid/3_7/affine_jacobian_iso_vol_weights_1_1/checkpoints/checkpoint_epoch_755_loss_3.263.pth'
