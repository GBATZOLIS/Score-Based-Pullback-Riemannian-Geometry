...
class DeformedSumOfGaussianPullbackManifold(Manifold): # TODO check input discrepancies between manifold mapping input and diffeomorphism input. Latter always assumes batch dimension
    ...
    def __init__(self, deformed_sum_of_gaussian, L=100, tol=1e-2, max_iter=20000, step_size=1/8, L2=200, tol2=1e-4, max_iter2=200): 
        super().__init__(deformed_sum_of_gaussian.d)
        self.dsg = deformed_sum_of_gaussian # multimodal distribution
        self.manifold = SumOfDiagonal(self.d, deformed_sum_of_gaussian.psi, deformed_sum_of_gaussian.weights, L=L, tol=tol, max_iter=max_iter, step_size=step_size, L2=L2, tol2=tol2, max_iter2=max_iter2)
        
        self.L = self.manifold.L
        self.tol = self.manifold.tol
        self.max_iter = self.manifold.max_iter
        self.step_size = self.manifold.step_size
