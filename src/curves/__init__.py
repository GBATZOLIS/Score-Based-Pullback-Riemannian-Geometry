...
class Curve(nn.Module): # TODO evaluation function without grad
    ...
    def fit(self, loss_function, num_time_points=100, num_epochs=1000, lr=0.01, weight_decay=0.01):
        ...
        for epoch in range(num_epochs): # TODO we could experiment with sampling times instead of having a fixed interval
            ...
            dot_dot_gamma_t = self.double_differential_forward(t)

            losses = loss_function(gamma_t, dot_gamma_t, dot_dot_gamma_t)
