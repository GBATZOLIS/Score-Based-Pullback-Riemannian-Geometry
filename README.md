...
These modifications enable us to construct a score-based pullback Riemannian metric that yields **closed-form geodesics** through the data probability density and enables **interpretable autoencoding** allowing us to capture the **intrinsic dimensionality** and **geometry** of data. We evaluate our method through:
